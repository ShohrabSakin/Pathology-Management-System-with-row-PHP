...
<form action="salestotal.php" method="get">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$q="SELECT * FROM salestotal where Date between '$d1' and '$d2' order by vrno asc ";
				//echo $q;
                $r=$m->query($q);
	...
	<thead>
		<tr>
			...
			<?php
				...
				$q="SELECT sum(Total) FROM salestotal where Date between '$d1' and '$d2' ";
				//echo $q;
                $r=$m->query($q);
				for($i=0; $row = $r->fetch_array(MYSQLI_NUM); $i++){
			?>
			...
			<?php
                ...
                $d2="$d21[2]-$d21[0]-$d21[1]";
                $m=new MySQLi("localhost","root","","project");
				$q="SELECT sum(Dicount) FROM salestotal where Date between '$d1' and '$d2' ";
				//echo $q;
                $r=$m->query($q);
				for($i=0; $row = $r->fetch_array(MYSQLI_NUM); $i++){
			?>
			...
			<?php
                ...
                $d2="$d21[2]-$d21[0]-$d21[1]";
                $m=new MySQLi("localhost","root","","project");
				$q="SELECT sum(Net) FROM salestotal where Date between '$d1' and '$d2' ";
				//echo $q;
                $r=$m->query($q);
				for($i=0; $row = $r->fetch_array(MYSQLI_NUM); $i++){
			?>
			...
			<?php
                ...
                $d2="$d21[2]-$d21[0]-$d21[1]";
                $m=new MySQLi("localhost","root","","project");
				$q="SELECT sum(Paid) FROM salestotal where Date between '$d1' and '$d2' ";
				//echo $q;
                $r=$m->query($q);
				for($i=0; $row = $r->fetch_array(MYSQLI_NUM); $i++){
			?>
			...
			<?php
                ...
                $d2="$d21[2]-$d21[0]-$d21[1]";
                $m=new MySQLi("localhost","root","","project");
				$q="SELECT sum(Due) FROM salestotal where Date between '$d1' and '$d2' ";
				//echo $q;
                $r=$m->query($q);
				for($i=0; $row = $r->fetch_array(MYSQLI_NUM); $i++){
			?>
