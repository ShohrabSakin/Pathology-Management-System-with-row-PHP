...
<?php include('navfixed.php');?>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Purchase Report
			</div>
			<ul class="breadcrumb">
...
if (isset($_GET['vrno']) ){
	...
	$q="SELECT * FROM purchestotal where vrno = '$vrno' limit 1 ";
	//echo $q;
	$r2=$m->query($q);
...
<div class="content" id="content">
	<h2 align="center">ABC Diagnostic Center</h2>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				if (isset($_GET['vrno'])){			
                $q="SELECT * FROM purcheslineitems where vrno = '$vrno' order by slno ";
				//echo $q;
                $r=$m->query($q);
